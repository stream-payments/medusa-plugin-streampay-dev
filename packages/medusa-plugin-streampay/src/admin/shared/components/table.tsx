...
const STREAM_PAYMENTS_DASHBOARD_URL = "https://dashboard.streampayments.app"
    ...
    cell: ({ row }) => {
      return (
        <div className="text-violet-60 flex">
          <a
            className="max-w-[100px] truncate text-blue-900"
            href={`${STREAM_PAYMENTS_DASHBOARD_URL}/payments/${row.original.id}`}
            target="_blank"
